...
既存アプリの調査と改修を通して、MVC、Eloquent、DB、外部API、ファイル出力、画像アップロードを段階的に学びます。標準開発環境にはLaravel Sailを使用します。
...
Windowsでは、WSL2のUbuntuとDocker Desktopを使用します。詳しい操作は [新入社員向け環境構築](docs/新入社員向け/環境構築.md) を参照してください。
